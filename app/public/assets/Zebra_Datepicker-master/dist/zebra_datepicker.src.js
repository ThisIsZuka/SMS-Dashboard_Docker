        ...
        var defaults = {
                    ...
                    if (regexp.length) {
                        ...
                        if ((segments = regexp.exec(str_date))) {
                            ...
                            var tmpdate = new Date(),
                                ...
                                Thai_months = ["มกราคม","กุมภาพันธ์","มีนาคม","เมษายน","พฤษภาคม","มิถุนายน", "กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤษจิกายน","ธันวาคม"],

                                Thai_days = ["วันอาทิตย์ที่","วันจันทร์ที่","วันอังคารที่","วันพุทธที่","วันพฤหัสบดีที่","วันศุกร์ที่","วันเสาร์ที่"],
                                        ...
                                        $.each(iterable, function(key, value) {
                                            ...
                                            if (segments[index + 1].toLowerCase() === value.substring(0, ((match.character === 'D' && !plugin.settings.days_abbr) || (match.character === 'M' && !plugin.settings.months_abbr) ? 3 : value.length)).toLowerCase()) {
                                                ...
                                                switch (match.character) {
                                                    ...
                                                    case 'M_TH': segments[index + 1] = english_months[key].substring(0, 6); original_month = key + 1; break;
                                                }
            ...
            format = function(date) {
                ...
                for (i = 0; i < plugin.settings.format.length; i++) {
                    ...
                    switch (chr) {
                        ...
                        case 'M': f = ($.isArray(plugin.settings.months_abbr) && undefined !== plugin.settings.months_abbr[n - 1] ? plugin.settings.months_abbr[n - 1] : plugin.settings.months[n - 1].substr(0, 6));   // jshint ignore:line
            ...
            generate_monthpicker = function() {
                ...
                for (i = 0; i < 12; i++) {
                    ...
                    html += '<td class="' + $.trim(class_name) + '">' + ($.isArray(plugin.settings.months_abbr) && undefined !== plugin.settings.months_abbr[month] ? plugin.settings.months_abbr[month] : plugin.settings.months[month].substr(0, 6)) + '</td>';
